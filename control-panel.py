...
class PanelDeControl(Gtk.Window):
    def __init__(self):
        ...
        self.crear_pestaña("System and Security", [("Firewall", "gufw"), ("Setup repositories", "pkexec setup-repos"), ("Cleaning system", "bleachbit"), ("GUI Package manager", "bauh")])
        ...
        self.crear_pestaña("Hardware and Sound", [("Setup print server", "pkexec cups-switch"), ("Sound control", "pavucontrol")])
        self.crear_pestaña("Users and Groups", [("Manager Users and Groups", "users-admin")])
